...
pub fn Settings(props: SettingsProps) -> Element {
    let submenu_items = vec![
        ("user-settings", "User Settings", "👤", "Personal preferences and account"),
        ("congregation-settings", "Congregation Settings", "⚙️", "Configure congregation details"),
    ];
    ...
    rsx! {
        div { class: "space-y-6",
            ...
            div { class: "mb-8",
                ...
                p { class: "text-base-content/70", "Configure application preferences" }
            }
