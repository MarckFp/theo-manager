...
pub struct CongregationProps {
    pub on_navigate: EventHandler<String>,
}

#[component]
pub fn Congregation(props: CongregationProps) -> Element {
    let submenu_items = vec![
        ("special-events", "Special Events", "🎉", "Assemblies and conventions"),
        ("absences", "Absences", "📅", "Track member absences"),
        ("cleaning", "Cleaning Schedule", "🧹", "Kingdom Hall maintenance"),
        ("maintenance", "Maintenance", "🔧", "Facility repairs and upkeep"),
        ("attendant", "Attendant", "🚪", "Meeting attendant schedule"),
        ("audio-video", "Audio & Video", "📹", "A/V team assignments"),
        ("territory", "Territory", "🗺️", "Preaching territory management"),
    ];
