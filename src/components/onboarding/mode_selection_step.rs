    ...
    rsx! {
        div { class: "space-y-6",
            ...
            div { class: "grid grid-cols-1 md:grid-cols-2 gap-4 mt-8",
                // Offline Mode
                div { 
                    class: if selected_mode() == Some(WorkingMode::Offline) {
                        "card bg-primary text-primary-content shadow-lg cursor-pointer border-2 border-primary transform scale-105 transition-all"
                    } else {
                        "card bg-base-100 border-2 border-base-300 shadow-md cursor-pointer hover:border-primary hover:shadow-lg transition-all"
                    },
                ...
                // Online Mode
                div { 
                    class: if selected_mode() == Some(WorkingMode::Online) {
                        "card bg-primary text-primary-content shadow-lg cursor-pointer border-2 border-primary transform scale-105 transition-all"
                    } else {
                        "card bg-base-100 border-2 border-base-300 shadow-md cursor-pointer hover:border-primary hover:shadow-lg transition-all"
                    },
            ...
            div { class: "flex flex-col sm:flex-row gap-3 mt-8 pt-6 border-t border-base-300",
                ...
                button { 
                    class: if selected_mode().is_some() {
                        "btn btn-primary btn-lg flex-1"
                    } else {
                        "btn btn-primary btn-lg flex-1 btn-disabled"
                    },
